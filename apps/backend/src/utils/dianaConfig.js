/**
 * Diana API configuration — default activity time windows.
 *
 * All time values are in MEZ (Europe/Vienna local time).
 * They MUST be converted to UTC before sending to the Diana API.
 * Use `localTimeToUtc()` from dianaService.js for conversion.
 *
