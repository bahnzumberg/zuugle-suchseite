...
| `filter`      | `/search`      | This is a JSON representation of the filter object. Reflects the currently active filter settings, which can be changed via the dialog on the search page.                                                                                                                                                                                                                                                                                             |
...
| `map`         | `/search`      | Will show a map with tour markers above the list of tours.                                                                                                                                                                                                                                                                                                                                                                                             |
...
| `country`     | `/search`      | Will only show tours from that country.                                                                                                                                                                                                                                                                                                                                                                                                                | `Schweiz`, `Italia`, `Österreich`                                                                            |

<!-- TODO: combine range and provider parameters with range setting in filter.  -->
<!-- TODO: Find out if country is currently used and improve. For end users it's not feasible to have to guess how to write the country name. Maybe integrate into filter dialog? -->
