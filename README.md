# purpose for branch
This is a branch to fix the bug of crashing when attempting to get detail tour drawer from the main map by clicking on the marker of a tour on map WITHOUT having first clicked on the tour box within the list on main page.
# what is new here:
