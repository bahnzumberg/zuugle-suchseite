...
import {RegionResultList} from "./Search/RegionResultList";

function FullScreenRegionInput({ initialRegion, onSelect, loadRegions, city, regions, searchParams, setSearchParams}){
    ...
    return <Box>
        <Box sx={{padding: "20px"}}>
            <RegionInput
                region={regionInput}
                setRegion={(value) => changeTextMiddleware(value, setRegionInput, setRegion)}
