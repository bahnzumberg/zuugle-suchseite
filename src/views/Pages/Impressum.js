    ...
    return <Box className={"about-container"}>
        ...
        <Box className={'start-body-container static-container'}>
            <Box style={{textAlign: "left"}}>
                <Typography variant={"h5"}>{ImpressumLabels.verantwortlich_fuer_inhalt}</Typography>
                ...
                <Typography variant={"h5"} sx={{marginTop: "20px"}}>{ImpressumLabels.spendenkonto}</Typography>
                ...
                <Typography variant={"h5"} sx={{marginTop: "20px"}}>{ImpressumLabels.kontakt} </Typography>

                <Typography><a href={"https://www.bahn-zum-berg.at/kontakt-mail.php"}>kontakt [at] bahn-zum-berg.at</a></Typography>

                <Typography variant={"h5"} sx={{marginTop: "20px"}}>{ImpressumLabels.vereinsvorstand}</Typography>
                ...
                <Typography variant={"h5"} sx={{marginTop: "20px"}}>{ ImpressumLabels.haftung_fuer_links}</Typography>
