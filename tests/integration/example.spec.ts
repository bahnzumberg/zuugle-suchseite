...
test.describe("Search Functionality", () => {
  ...
  test("search via map works", async ({ page }) => {
    ...
    await page.goto(
      "/search?lang=de&city=bad-ischl&map=true&geolocation=%7B%22lat%22%3A47.43363460079756%2C%22lng%22%3A13.860470283673397%2C%22radius%22%3A4491.585996694814%7D",
    );
